    ...
    df = pl.DataFrame(
        {
            ...
            "my_table_results": [
                "- I have several results available [here](https://www.google.com/) <br> - and another one [here](https://www.qwant.fr)"
            ],
            "my_table_repo_path": [
                "- [here](https://www.google.com/) <br>- or [here](https://www.google.com/)"
            ],
